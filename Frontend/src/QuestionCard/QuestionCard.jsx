...
function QuestionCard({ title, answer, isPinned, onLearnMore, onTogglePin }) {
  ...
  return (
    <section className="bg-white rounded-lg mb-4 overflow-hidden py-4 px-6 shadow-xl shadow-gray-100/70 border border-gray-100/60 group">
      <section className="flex items-start justify-between cursor-pointer w-full q">
        <div className="flex items-start gap-3.5">
          <span className="text-md md:text-[15px] font-semibold text-gray-400 leading-[18px]">
            Q
          </span>
          <h3
        ...
        <div className="flex items-center justify-end ml-4 relative">
          ...
          >
            ...
            >
              <LuSparkles className="hidden md:block text-md" />
