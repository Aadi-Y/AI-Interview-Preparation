  ...
  return (
    <>
      <section>
        <section>
          <div>
            <h1 className="text-[16px] text-center md:text-[1.3rem] font-semibold mb-2">
              Session survey
            </h1>
            <p className="text-gray-600 text-[14px] md:text-[15px] mb-2">
              Fill up all the following questions to start the interview journey
            </p>
          </div>
          <form onSubmit={handleSubmit} className="flex flex-col gap-3">
            <div>
              <label className="text-[14px] md:text-[15px]">Target Role</label>
              <Input
                text="text"
            ...
            <div>
              <label className="text-[14px] md:text-[15px]">Year of Experience</label>
              <Input
                text="number"
            ...
            <div>
              <label className="text-[14px] md:text-[15px]">Topic to Focus on</label>
              <Input
                text="text"
            ...
            <div>
              <label className="text-[14px] md:text-[15px]">Description</label>
              <Input
                text="text"
            ...
            <div>
              <button
                ...
                className="w-full flex justify-center items-center gap-2 py-3 rounded-xl 
                           ...
                           disabled:opacity-60 disabled:cursor-not-allowed cursor-pointer md:text-[15px] text-[14px]"
              >
                {loading ? (
                  <>
