...
function AIResponsePreview({ content }) {
  ...
  return (
    <section className="max-w-4xl mx-auto">
      <section className="text-[14px] prose prose-slate dark:prose-invert max-w-none">
        <ReactMarkdown
          ...
          components={{
            ...
            th({ children }) {
              return (
                <th className="px-3 py-2 text-left text-sm font-semibold text-gray-600 uppercase tracking-wider">
                  {children}
                </th>
              );
            },
    ...
    <div className="relative my-6 rounded-lg overflow-hidden bg-gray-50 border border-gray-200">
      ...
      <div className="flex items-center justify-between px-4 py-2 bg-gray-100 border-b border-gray-200">
        ...
        >
          ...
          {copied && (
            <span className="absolute -top-6 right-0 bg-black text-white text-xs rounded-md px-2 py-0.5 opacity-90">
              Copied!
            </span>
          )}
        </button>
